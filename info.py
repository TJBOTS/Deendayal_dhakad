...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001786924542').split()]  # Channel id for auto indexing (make sure bot is admin)
